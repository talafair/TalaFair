...
@section('content')
  ...
  <div class="card yg-card">
    <div class="list-group list-group-flush">
          ...
          <div class="d-flex gap-3">
            ...
            <div class="flex-grow-1">
              ...
              @if ($notification->announcement)
                <a href="{{ route('announcements.show', $notification->announcement) }}" class="small fw-semibold text-yg text-decoration-none">
                  View related announcement <i class="bi bi-arrow-right"></i>
                </a>
              @elseif ($notification->survey)
                <a href="{{ route('surveys.show', $notification->survey) }}" class="small fw-semibold text-yg text-decoration-none">
      ...
      @empty
        <div class="text-center text-secondary py-5 px-4">
