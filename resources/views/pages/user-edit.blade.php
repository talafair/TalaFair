  ...
  <form method="POST" action="{{ route('users.update', $user) }}">
    ...
    <div class="card yg-card mb-4">
      <div class="card-body p-4">
        ...
        <div class="row g-3">
          <div class="col-md-4"><label for="role" class="form-label">Category</label><select name="role" id="role" class="form-select" required><option value="resident" @selected($user->role === 'resident')>Resident</option><option value="guest" @selected($user->role === 'guest')>Guest</option><option value="official" @selected($user->role === 'official')>Official</option></select></div>
